...
CONFIG_LIST = [
	...
	# Configuration(
	# 	config_family=P.CONFIG_FAMILY_SDM,
	# 	config_name='sgd_base', # Val: 85.72, Test: 84.95
	# 	net_class=basemodel.model.Net,
	# 	batch_size=64,
	# 	num_epochs=20,
	# 	iteration_ids=[0],
	...
	Configuration(
		config_family=P.CONFIG_FAMILY_GDES,
		config_name='sgd_base5', # Train:97.95 Val:87.22, Test:
		net_class=basemodel.model.Net,
		batch_size=64,
		num_epochs=5,
		iteration_ids=[0],
	...
	Configuration(
		config_family=P.CONFIG_FAMILY_HEBB,
		config_name='gdes20_5_hebb', # Train:98.10 Val:87.38, Test:
	...
	Configuration(
		config_family=P.CONFIG_FAMILY_HEBB,
		config_name='gdes5_5_hebb5', # Train:98.10 Val:87.38, Test:
		net_class=hebbmodel.fc.Net,
		batch_size=64,
		num_epochs=5,
		iteration_ids=[0],
